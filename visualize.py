...
# CONSTANT VALUES
    ...
    FONT = pygame.font.SysFont('CaskaydiaCove NF',18)
    LARGE_FONT = pygame.font.SysFont('CaskaydiaCove NF',28)
    SIDE_PADDING = 100
    TOP_PADDING = 150
    ...
    for i in range(len(lst)-1):
        for j in range(len(lst)-1-i):
            ...
            if (num1 > num2 and ascending) or (num1<num2 and not ascending):
                ...
                yield True   # returning generator object so that we can still use controls  
    return lst
...
def main():
    ...
    draw_info = DrawInfo(600,800,lst)
    sorting = False
    ascending = True
